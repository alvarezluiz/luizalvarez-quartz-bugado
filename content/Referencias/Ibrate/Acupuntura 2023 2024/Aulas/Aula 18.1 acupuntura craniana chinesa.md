---
title: 18 - 1 Acupuntura craniana chinesa
...
Combina técnicas de acupuntura tradicional chinesa com modernos conhecimentos sobre as áreas representativas da cortex cerebral.
...
- Estimulação do couro cabeludo obedecendo as localizações corticais encefálicas;

- Isenta de teoria Yin e Yang, equilibrio de Qi, 5 elementos e meridianos.
...
02. Intumescimento e afasia de origem cerebral;

03. Vertigens, enurese, incontinência urinária de origem cortical;

04. Distúrbios neurológicos em gânglios de base (coréia);

05. Síndrome de Parkinson;

06. Alguns distúrbios neurológicos com perfil de hipertonia muscular;

07. Polineurites, radiculites;

08. Síndrome de Mèniere, lesões inflamatórias do nervo auditivo;

09. Cefaléias psicogênicas;
...
- Pacientes com hipertensão não estabilizada;
- Cuidar com hemorragia na aponeurose;
- Pacientes debilitados (podem desmalar, apresentar náuseas ou cefalelas);
- Pós craniotomia, crianças (fontanela).
